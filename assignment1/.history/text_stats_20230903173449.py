...
# calcuate word frequencies after implementing stop words
# similar to function above
# tokenizing words using text.strip().split() instead of nltk word_tokenize
def word_frequencies_stop(data):
